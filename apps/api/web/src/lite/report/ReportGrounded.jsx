...
export function ReportGrounded() {
  return (
    <div className="lite-report-grounded-grid" style={{ borderTop: '1px solid var(--hairline)', paddingTop: 20, marginBottom: 22, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 28 }}>
