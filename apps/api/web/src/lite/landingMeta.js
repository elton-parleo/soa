 ...
 * app module) can import it directly. That's also why OG_IMAGE_URL is
 * built from audit-host.constants.js's DEFAULT_PUBLIC_AUDIT_BASE_URL,
 * not publicUrls.js's env-aware PUBLIC_AUDIT_BASE_URL (which would
 * throw here — import.meta.env doesn't exist in vite.config.js's own
...
// provenance). Every consumer must still treat a null value here as
// "omit the tag entirely" if this is ever reset — never fabricate a
// path that would just 404 on every unfurl.
export const OG_IMAGE_URL = `${DEFAULT_PUBLIC_AUDIT_BASE_URL}/og/audit-landing.png`
